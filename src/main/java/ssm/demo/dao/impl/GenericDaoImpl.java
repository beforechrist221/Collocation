...
泛型Dao接口的实现类
 */
public abstract class GenericDaoImpl<T extends Serializable,ID extends Number> implements GenericDao<T,Integer> {

//    private SqlSession sqlSession;
    private String namespace;//TODO:    Reflect反射
...
//        private SqlSession sqlSession;
    abstract void setSqlSession(SqlSession sqlSession);
    ...
    @Override
    public void add(T t) {
        sqlSession.insert(getStatement("add"),t);
    }
