		...
		<div class="container">
			<div class="row ">
				<div class="col-md-1 full-width-content">
					<%--${sessionScope.collocation}--%>
					<article class="content-item">
						<div class="entry-media">
							<div class="post-title">
								<h2>
									<a>${sessionScope.collocation.title}</a><br>
									<a style="font-size: small">${sessionScope.collocation.introduce}</a>
								</h2>
								<div class="entry-date">
									<ul>
										<li>
											<a href='#'>${sessionScope.collocation.type.typename}</a>
										</li>
                                        <li>${sessionScope.collocation.user.username}</li>
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                ...
                                                <li><a href="${ctx}collocation/queryById/${collocation.id}.action">EDIT</a></li>
                                            </c:otherwise>
                                        </c:choose>
							...
							<div class="post-content full-width">
								...
								<p>
									${sessionScope.collocation.content}
								</p>
							</div>
						</div>
					</article>
